...
void Lucky(ll other, ll other1, ll other2){
    if(other > 10000000000ll) return;
    if(other1 == other2) v.pb(other);
    Lucky(other*10ll + 4ll, other1+1, other2);
    Lucky(other*10ll + 7ll, other1, other2+1);
}
void solve(){
    ll n;
    cin >> n;
